...
export default function Pemerintahan({ settings, pejabat, title, deskripsi }: Props) {
        ...
        <PortalLayout title={title} settings={settings as any}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mb-16 text-center space-y-4">
                    <h2 className="text-2xl font-black text-slate-800 dark:text-zinc-100">Bagan Struktur Organisasi</h2>
                    <p className="text-xs text-muted-foreground max-w-xl mx-auto">
                        Berikut adalah susunan personil pejabat pemerintahan Desa {desaName} yang bertugas melaksanakan pelayanan publik dan pembangunan kemasyarakatan.
                    </p>
