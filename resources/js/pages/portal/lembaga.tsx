...
export default function Lembaga({ settings, pejabat, title, deskripsi }: Props) {
        ...
        <PortalLayout title={title} settings={settings as any}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mb-16 text-center space-y-4">
                    <h2 className="text-2xl font-black text-slate-800 dark:text-zinc-100">Lembaga Kemasyarakatan Desa (LKD)</h2>
                    <p className="text-xs text-muted-foreground max-w-xl mx-auto">
                        Berikut adalah daftar kepengurusan lembaga kemasyarakatan Desa {desaName} (seperti PKK, Karang Taruna, LPM, dan MUI) yang aktif bermitra membangun desa.
                    </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {pejabat.length > 0 ? (
                        ...
                        <div className="col-span-full text-center py-12 text-muted-foreground">
                            Data pengurus lembaga belum diunggah.
                        </div>
                    )}
                </div>
